    ...
    <?php include("header.php"); ?>
        ...
        <div class="row m-5 justify-content-center">
            ...
            <div class="col pl-4 mytext">
                ...
                <br>
                <br>
                <a target="_blank" href="https://github.com/mriviere-company">Github : <i class="fab fa-github"></i></a>
                <br>
                <a target="_blank" href="https://www.linkedin.com/in/rivierematthieu/">Linkedin : <i class="fab fa-linkedin"></i></a>
                <br>
                <a target="_blank" href="https://www.instagram.com/matthieu_rvr_/">Instagram : <i class="fab fa-instagram"></i></a>
            </div>
        </div>
        </body>
